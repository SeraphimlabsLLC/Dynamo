...
#define DCC_GENERATE true //Turn DCC test signal generator on or off
...
// Alternative: esp_timer_get_time();
  ...
  #define LN_MODE Master //MASTER has priority 0. SENSOR has priority delay of 6 down to 2. THROTTLE has priority delay of 20 down to 6. 
//Fast Clock settings, only for Arch Bridge
